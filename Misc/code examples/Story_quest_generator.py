...
# will have a quest after the problem but it must be Y/N answers
    ...
    quests_what_he_problem = [ "that he wanted to ride a roller coaster, but a giant pool of slime is in the way.",
                               "he really wants to buy a home, but the problem is a giant Ladybug appears blocking his path, and won't let him past.",
...
This will generate a quest somehow, please answer the questions below!
...
********************************************************************************
    ...
    sys.stdout.write("(Who)Enter a number between 1-23: ")
    who_answer = int(sys.stdin.readline())
    
    sys.stdout.write("(quest intro)Enter a number between 1-3: ")
    story_answer = int(sys.stdin.readline())
    
    sys.stdout.write("(Quest)Enter a number between 1-5: ")
    quest_answer = int(sys.stdin.readline()) 
...
""")
    ...
    sys.stdout.write ("One day, you are just standing there, minding your own business. \n\n When your freind approaches you. \n\nThey begin to tell you a story...........")   
    sys.stdout.write ("\n\n" + (story_introduction[(story_answer)]) + who[(who_answer)] + ".\n\n" +  
                      "Who told me "+ (quests_what_he_problem [(quest_answer)]))
    sys.stdout.write ("\n\n" + name_answer + "What do you do?")
