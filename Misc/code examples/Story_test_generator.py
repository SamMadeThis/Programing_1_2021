...
********************************************************************************
    ...
    sys.stdout.write("Enter a number between 1-23: ")
    who_answer = int(sys.stdin.readline())
    
    sys.stdout.write("Enter a number between 1-25: ")
    what_answer =int(sys.stdin.readline())
    
    sys.stdout.write("Enter a number between 1-26: ")
    problem_answer = int(sys.stdin.readline())
...
""")
    ...
    sys.stdout.write("\n\n" + (name_answer) + " is a " + (who[(who_answer)]) + " who wants to " + 
